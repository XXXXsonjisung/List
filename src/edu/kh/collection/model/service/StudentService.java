...
public class StudentService {
	...
	// private List<Student> sudentList = new ArrayList<Student>(); //검색(조회)에 효율적
	 ...
	 public void ex() {
		...
		//studentList.add(new Object()); 3번
		 ...
		 // (반환형)
		 //Object List.get(indx i) : 리스트에서 i번째 인덱스에 있는 객체를 반환
		...
		do {
			...
			try {
				...
				default : System.out.println("메뉴에 작성된 번호만 입력해주세요.");
					...
					sc.nextLine(); // 입력 버퍼에 남아있는잘못된 문자열 제거
	...
	public String addStudent()throws InputMismatchException{
		...
		int age = sc.nextInt();
		sc.nextLine();// 입력 버퍼 개행 문자 제거 (int 다음 Line 나올시)
		...
		public void selectAll() {
			...
			// studentList가 비어있는 경우 "학생 정보가없습니다. " 출력
...
//				
		...
		public String updateStudent() throws InputMismatchException{
			...
			// 입력받은 index번재에 새로운 학생 정보를 세팅 == 수정
